...
import com.hyy.jingweibo.support.lib.LayerEnablingAnimatorListener;
...
public class LocalWorker extends AbstractWorker<String, Integer, Bitmap> {
    ...
    public LocalWorker(IJingweiboDrawable view, String url, FileLocationMethod method,
            boolean isMultiPictures) {
    ...
    private void displayBitmap(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            if (IJingweiboDrawable != null) {
                IJingweiboDrawable.setGifFlag(ImageUtility.isThisPictureGif(getUrl()));
            }
